...
@Mahiru.on_message(filters.command("addsudo", PREFIX) & owner_only)
...
@Mahiru.on_message(filters.command("rmsudo", PREFIX) & owner_only)
...
@Mahiru.on_message(filters.command("sudols", PREFIX) & owner_only)
